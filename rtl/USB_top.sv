...
// ============================================================================
// USB 1.1 Full-Speed device controller (EP0 control read + EP1 interrupt IN)
...
module USB_top #(
  ...
  input  logic clk,
  input  logic rst_n,
  inout  wire  dp,              // D+ tri-state pad (device drives when tx_oe)
  ...
  wire rx_en    = (ts == TS_IDLE);        // never receive our own transmit
